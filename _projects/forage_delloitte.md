...
This project is based on the **Deloitte Australia Cyber Job Simulation** delivered through **Forage**, designed to mirror the type of analytical and investigative tasks performed by cybersecurity consultants and SOC analysts in real client engagements.

The simulation focused on **detecting suspicious behavior**, supporting a client during a **cybersecurity incident**, and communicating findings in a structured and defensible manner.
