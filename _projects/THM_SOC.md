...
<div class="justify-text">
- Path status: <strong>in progress</strong> (SOC Level 1).  
- Recent milestone: <strong>Phish Hunter</strong> (Phishing Analysis room series completed).  
</div>
