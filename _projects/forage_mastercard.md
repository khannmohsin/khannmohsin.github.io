...
This project is based on the **Mastercard Cybersecurity Virtual Experience Program** delivered through **Forage** (January 2026).  
The simulation mirrors the responsibilities of a **Security Awareness Analyst** working within a global financial organization.

The work focused on **phishing threat identification**, **human-centric security risk**, and **designing targeted awareness and training programs** to reduce organizational exposure to social engineering attacks.
