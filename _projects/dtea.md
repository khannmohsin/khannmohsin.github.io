...
## System Architecture
{% include figure.liquid path="assets/img/projects/dtea/dtea-architecture.png" title="Smart contract and blockchain-assisted distributed trust enforcement architecture" class="img-fluid rounded z-depth-1" %}
<div class="caption">
...
{% include figure.liquid path="assets/img/projects/dtea/dtea-layers.png" title="Layered Trust-Enforcement Architecture of DTEA" class="img-fluid rounded z-depth-1" %}
<div class="caption">
